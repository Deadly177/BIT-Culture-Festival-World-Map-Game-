...
const { guessed, isLatestCountryGuessed } = useCountryGuessed('GA')
...
<template>
  <g id="ga" class="landxx coastxx ga" :class="classes">
    <metadata id="title115">Gabon</metadata>
    <path
      id="path5980"
